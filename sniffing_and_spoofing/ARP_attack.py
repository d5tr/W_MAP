...
# IP target
target = str(input(f'[{Fore.CYAN}?{Fore.WHITE}] Enter {Fore.RED}" any IP "{Fore.WHITE} in your network :'))
# IP spoof

spoofs = str(input(f'[{Fore.CYAN}?{Fore.WHITE}] Enter {Fore.RED}" IP network "{Fore.WHITE} :'))
